...
- infiles_folder: folder where multiple user-input files are located. Their names must match the following pattern: infile\_<number of sequences>\_seqs.txt. Each file must contain the 'cdr3_aa' header. ([infiles](data/infiles))
...
the other folder contains the results of the GNU time command and CompAIRR log files ([time](benchmarking/time)). 
